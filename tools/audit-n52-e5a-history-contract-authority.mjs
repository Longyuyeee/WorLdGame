...
if (authority?.status !== "active" || !["N52", "N60", "N61"].includes(authority?.maximumDeliveryNode) || authority?.historyScopeAmendedAt !== "2026-09-01T01:02:18+08:00") violations.push("RA-N21-011 History amendment is missing");
