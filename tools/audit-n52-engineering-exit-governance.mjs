...
if (!["N52", "N60", "N61", "N62"].includes(authority?.maximumDeliveryNode)) violations.push("risk authority no longer preserves the N52 historical boundary or bounded later continuation");
