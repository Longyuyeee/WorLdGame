...
for (const token of ['WORLD_PLAYER_PLAYBACK_POLICY_VERSION = "1.2.0"', "defaultActivation", "defaultSpeed", "instantInstructionBudget"]) if (!policy.includes(token)) violations.push(`Playback Policy token missing: ${token}`);
