...
if (authority?.status !== "active" || !["N52", "N60"].includes(authority?.maximumDeliveryNode) || authority?.playbackEvidencePath !== "docs/254-n52-e4d-build-stop-point-source-audit.md") violations.push("RA-N21-011 Player Stop Point amendment is not active or exact");
