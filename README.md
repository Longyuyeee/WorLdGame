...
> 文档基线：2026-08-13
> 当前阶段边界：N31 Engineering 已完成 VM-01–VM-15 `15/15`；N32-E1–E7 已把 Editor Preview 接到正式 Compiler/Runtime，并提取共享 portable Runtime Host。N40-E1–E3 已建立 Compiler 驱动的 Route Map、Project Service 跨视图写回、真实 10k 分支投影、64 节点有界窗口，以及可保存/重建且不污染剧情的 Canonical Layout Sidecar；分组/折叠、存储级按需载入、路线高亮、10k 局部编辑/500 ms 门、正式 Player、真人产品验收、N41+、M1 与发布仍被阻断。
