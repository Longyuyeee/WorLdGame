...
export const WORLD_STUDIO_DATABASE_VERSION = 4;
...
export const ASSET_BACKUP_STORE_NAME = "asset-backups";
  ...
  return new Promise((resolve, reject) => {
    ...
    request.addEventListener("upgradeneeded", () => {
      for (const storeName of [PROJECT_FILE_STORE_NAME, ASSET_BLOB_STORE_NAME, ASSET_INDEX_STORE_NAME,
        ASSET_LIFECYCLE_STORE_NAME, ASSET_TRASH_STORE_NAME, ASSET_BACKUP_STORE_NAME]) {
