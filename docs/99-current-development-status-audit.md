...
| GitHub CI | PR #23–#34 最近 Windows CI 均成功；Draft PR #35 实现头 `1125b68` 的 `product-baseline` run `31876049419` 已启动 | 等待远端 Windows / Node 22 完整门 |
...
| #35 | N30-E2 | 基于 #34 分支 | Draft、实现头 `1125b68` CI 运行中 |
