...
> 最新节点证据：[N50-E3 Media Parity/Recovery 审计](215-n50-e3-player-media-parity-recovery-audit.md)、[N50-E2 Player Stage/Media 审计](214-n50-e2-player-stage-media-presentation-audit.md)、[N50-E1 正式 Player Core 审计](212-n50-e1-formal-player-core-audit.md)
...
| Player/Build | N50-E1 portable Core/共享 Shell；E2/E3 已消费正式 Effect、真实 PNG/WAV、结构 parity、多通道与重试恢复；桌面/390×844 实测无横溢出 | 存档/历史/设置/Auto/Skip/Back、Gallery、手柄、三端正式宿主、Web/PWA、Windows、APK/AAB、签名、安装、升级与发布材料均缺 |
