...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1 已完成 Compiler 事实与 Project Service 改名闭环；E2 已通过真实 10k 二叉分支图、索引和 64 节点有界 DOM；E3 已完成最小 Canonical Layout Sidecar、保存/重建、剧情隔离与真实工程重开。仍缺分组/折叠/视口/拖拽、存储层按需载入、高级过滤、路线高亮、10k 局部编辑与 500 ms 门 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1 已从正式 Compiler 自动生成创作者 Route 与诊断；E2 已证明 10k 二叉分支投影和有界窗口；E3 已证明脚本更新保留布局、布局删除重建不损剧情并可真实保存重开。运行高亮、存储级按需载入和 N62 玩家自动图仍缺 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md) |
