...
| REQ-UX | 设计 Token、七模式、Beginner/Pro、统一语义、连续动效、60 FPS、减少动效、多模态状态 | N43/N101 | N21/N40–42 | 实现中 | N43-E1/E2 已关闭四个可用模式、统一上下文和 Beginner/Pro；E3 增加完整/简化/静止、系统减少动效优先级、非颜色状态和真实页面帧预算，三级 P95 `12.30/12.20/6.20ms`。其余三模式、键盘/触屏任务、真实 OS/目标设备与真人证据仍未完成 | [N43-E3](206-n43-e3-motion-state-semantics-audit.md)、[N43-E2](205-n43-e2-progressive-disclosure-audit.md)、[N21 执行包](114-n21-human-validation-execution-kit.md) |
