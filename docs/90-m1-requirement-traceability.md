...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1–E3c4 已接入 History、存读档、恢复与 checkpoint；N52-E4 Auto/Skip 入口合同已关闭并确认正式 N31 Scheduler 尚未接入 Player Core。播放实现、真实强杀、三端与真人证据仍缺 | [N52-E4 入口](249-n52-e4-auto-skip-entry-audit.md)、[N52-E3c4](247-n52-e3c4-save-v3-checkpoint-slots-audit.md)、三端状态一致 |
...
| AC-15 | Auto 和四种 Skip 正确 | N31/N52 | 实现中 | N31-E6 正式内核已证明调度等价与停止规则；N52-E4 Auto/Skip 入口合同又确认 Player Core/Shell/Embed 尚未接线，并冻结 Forward History、宿主 suspend、真实语音 duration 与媒体清理边界。入口不是产品通过；E4a–E4c、三端与真人证据仍缺 | [N52-E4 入口](249-n52-e4-auto-skip-entry-audit.md)、[N31-E6 审计](131-n31-e6-runtime-scheduler-audit.md)、玩家输入向量和 State Hash |
