...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E8k 已完成 Compiler 图、10k/64 窗口、Layout/交互、缓存、Runtime 高亮、trusted Route-first、局部 Script/Sequence、全局索引、narration 结构闭环与 topology 分页；E8l–E8m 完成指定结局审阅和诊断/目标导航；E8n 已完成 Choice stable-ID 目标修改→保存复读→Compiler/Route 重建→Formal Runtime 新结局的最小写闭环，10k plan Windows `0.79 ms <250 ms`，desktop/mobile production 通过。下一步是 N40 Engineering 出口复审；完整 Lazy Project/增量 topology、外部目录、角色/变量/覆盖过滤仍未纳入已完成范围 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、[N40-E8a](164-n40-e8a-single-project-read-audit.md)–[N40-E8k](174-n40-e8k-trusted-route-topology-page-audit.md)、[N40-E8l](176-n40-e8l-ending-route-review-audit.md)–[N40-E8n](178-n40-e8n-route-repair-loop-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E8m 已建立自动图、10k/64 窗口、缓存、Runtime 高亮、trusted Route-first、全局索引、narration 结构事务、topology 分页、结局审阅和诊断/目标导航；E8n 又以正式 Story Language 事务关闭 Choice 目标修改→保存复读→Compiler/Route 重建→Formal Runtime 目标结局闭环。N40 Engineering 仍待出口复审；完整 Lazy Project/增量 topology 后置，N62 玩家自动图未开始 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、[N40-E8a](164-n40-e8a-single-project-read-audit.md)–[N40-E8k](174-n40-e8k-trusted-route-topology-page-audit.md)、[N40-E8l](176-n40-e8l-ending-route-review-audit.md)–[N40-E8n](178-n40-e8n-route-repair-loop-audit.md) |
