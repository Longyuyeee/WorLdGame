...
| REQ-L10N | 语言、稳定文本 ID、CSV/XLSX、状态、运行切换、CJK/Ruby | N61 | N10/N30/N50 | 实现中 | N61-E1–E5 已完成文本生产/交换、Player 即时切换、CJK/Ruby/字体回退以及语言媒体和 stable-text-ID Voice 消费；仍缺 E6 Production 媒体/配音绑定与状态闭环、E4 移动断行实测和三端实体一致性 | [N61-E5 审计](278-n61-e5-localized-media-voice-mapping-audit.md)、[N61-E4 审计](277-n61-e4-cjk-ruby-font-fallback-audit.md)、三端语言切换 |
