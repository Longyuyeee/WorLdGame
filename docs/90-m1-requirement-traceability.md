...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1/E2 已贯通 History 与最小 Save/Load；N52-E3a v2 元数据与截图候选增加 strict v1 copy-on-write、12 槽分页、Host 捕获及同事务 Blob。Auto/Quick/检查点/恢复/Museum、Auto/Skip、真实设备和 Windows/Android 宿主仍缺 | [N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、[N52-E2](239-n52-e2-player-save-slots-audit.md)、[N50-E6](218-n50-e6-player-embed-api-audit.md)、三宿主 Golden |
