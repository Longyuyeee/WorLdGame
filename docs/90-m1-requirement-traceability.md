...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1 已用真实 PNG/WAV 关闭 16:9 Canvas 点击、s1 重开、Canonical 资源桥与 Runtime Host；E2 冻结 4 种 Move easing；E3 关闭“当前 Show/Move→下一 stable-ID Move 关键帧”的图形化编排。E3b 又在生产浏览器完成 X=72/Y=84/scale=1.05/650ms/ease-out 的编辑→s1 保存→刷新重开→Formal Runtime `stmt_ui_1 #3`→Stage x/y/easing 可见闭环；普通全仓 748/748。多轨 playhead、时间标尺、路径、镜头、模板仍缺 | [N42-E3b](193-n42-e3b-preview-production-loop-audit.md)、[N42-E3](190-n42-e3-character-keyframe-authoring-audit.md)、[N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N22 退出审计](113-n22-exit-condition-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b 已证明真实 PNG Stage 点击生成 stable-ID Script patch；E2 证明 easing 同源；E3 证明图形关键帧仍只生成 canonical stable-ID Move，经同一事务写回 Script 并由 Preview/Runtime 既有链消费，没有第二套时间轴状态。完整时间线和 N43 七模式仍未关闭 | [N42-E3](190-n42-e3-character-keyframe-authoring-audit.md)、[N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N42-E1b](188-n42-e1b-production-media-stage-audit.md)、ChangeSet/Hash 对照 |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | E2 已让真实角色 Move 的几何、duration 与 easing 进入 Canvas/DOM 和正式 Runtime Host；E3 提供基本角色关键帧图形编排并生成完整 Move 几何/timing。复杂多轨关键帧、路径、镜头、真实 Player 渲染/音频 Adapter 与三端媒体宿主仍缺 | [N42-E3](190-n42-e3-character-keyframe-authoring-audit.md)、[N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、Media Golden 三端快照 |
