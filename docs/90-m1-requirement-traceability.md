...
最近通过节点：`N20`。N21 的完整 P0 卡片、类型化 Inspector、原子批量事务、输入等价和保存重开已通过本地完整门，正在等待 Draft PR Windows CI 与 20 分钟非程序用户实测；证据见[《N21 最小 Writer/Sequence 编辑审计》](98-n21-writer-sequence.md)。产品验收前不进入 N22。
...
| REQ-SEQ | P0 语句块、排序/复制/批量/折叠、Inspector、跨视图定位 | N21/N41 | N21 | 实现中 | N21 自动化实现门完成；仍缺真人任务、N41 完整 Sequence 与 Stage 跨视图联动 | Branching/Media E2E |
