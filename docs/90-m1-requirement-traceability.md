...
> 集成边界：当前开发链仍未进入 `main`；N00–N41 Authority 对应 main-target Draft PR #61，仍等待维护者审阅与合并。N40–N50 Engineering 出口不得换算成 Product Acceptance；`RA-N21-010` 只准入 N51 Gal Settings Engineering，持续阻断 N51 Product Acceptance、N52 及以后、M1 Stable 与发布。N51-E6 已完成 P0 gap matrix 与入口设计冻结，但字段实现和出口均未完成。
...
| REQ-GAL | 可搜索设置、继承/撤销/预览、完整 Gal P0、附加页模板、六类音量、三平台 Profile | N51/N52/N61/N62/N80–N83 | N10/N31/N50/N51 | 实现中 | E1–E5 已建立首批 23 字段、三层继承/来源、Basic/Advanced、NFKC 搜索、Canonical ChangeSet/Undo/Redo、现代 UI 与共享 Preview/Player application；UI 保存重开、settings-only 保持 Core、桌面/390×844 production browser 通过。E6a 已实现严格 v1/v2 读取、统一 v2 写回和真实 Node/IndexedDB 迁移重开；剩余 P0、N52/N61/N62/N80+ 执行系统与正式 Windows/Android Host 实机仍未完成 | [范围消歧 #220](220-n50-n52-scope-reconciliation.md)、[N51 治理 #221](221-n50-n51-governance-checkpoint.md)、[N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、[N51-E2 #223](223-n51-e2-settings-catalog-editor-audit.md)、[N51-E3 #225](225-n51-e3-project-settings-transaction-audit.md)、[N51-E4 #226](226-n51-e4-modern-settings-ui-audit.md)、[N51-E5 #227](227-n51-e5-settings-runtime-application-audit.md)、[N51-E6 入口 #229](229-n51-e6-p0-gap-matrix-and-entry-audit.md)、[N51-E6a #230](230-n51-e6a-settings-schema-v2-migration-audit.md) |
...
| AC-19 | Gal 配置中心覆盖 P0 | N51 | 实现中 | E1–E5 覆盖首批 23 字段、三层来源、Basic/Advanced、搜索、Canonical 文件、Project ChangeSet/Undo/Redo、产品 UI 与 Preview/Player 热应用；E6a 已完成 v1→v2 严格迁移、确定性写回、真实双持久化重开与 schema-only Core 保持。完整 P0 字段、附加页执行及正式 Windows/Android Host 仍缺 | [N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、[N51-E2 #223](223-n51-e2-settings-catalog-editor-audit.md)、[N51-E3 #225](225-n51-e3-project-settings-transaction-audit.md)、[N51-E4 #226](226-n51-e4-modern-settings-ui-audit.md)、[N51-E5 #227](227-n51-e5-settings-runtime-application-audit.md)、[N51-E6 入口 #229](229-n51-e6-p0-gap-matrix-and-entry-audit.md)、[N51-E6a #230](230-n51-e6a-settings-schema-v2-migration-audit.md)、配置追踪全覆盖 |
