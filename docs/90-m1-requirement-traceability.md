...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线已在 Draft PR #51 的 Windows / Node 22 完整门（run `32352341550` / job `96374022660`）绿色后成为 Authoritative。N22 与 N23-E1–E7 工程门已完成，N30-E1/E2 Compiler 为未集成工程退出候选；N31-E1–E14 已通过未集成的 Engineering 出口。N32-E1 已进入未集成 Engineering 实现；`RA-N21-004` 不改变 N21/N23/N30/N31 产品验收，也持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
