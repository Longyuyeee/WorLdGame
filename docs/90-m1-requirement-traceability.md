...
|---|---|---|---|---|---|---|
| REQ-PRJ | 新建/打开/最近/示例、保存恢复、章节场景、搜索、桌面/手机工作区、导入导出、离线 | N10–N13/N90/N91 | N00 | 实现中 | N10 Schema 已通过；N11 统一事务命令实现中；尚无 N12/N13 文件生命周期与管理 UI | Project E2E、Recovery Golden、双端任务 |
