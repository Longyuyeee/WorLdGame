...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1/E2 已接入 History/Back/Forward 与手动 Save/Load；E3a 关闭 v2 元数据、strict v1、12 槽分页和 Host 截图 Blob；E3b 关闭 auto 5 / quick 1 与串行失败保留；E3c1 已关闭隔离恢复与五向量 Migration Museum。Skip、build-authored checkpoint、真实强杀、三端与真人证据仍缺 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、[N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1/E2 已贯通 History 与 Save/Load；E3a 关闭 strict v1 copy-on-write、12 槽与截图 Blob；E3b 已关闭 auto 5、quick 1、串行及失败保留；E3c1 已关闭 DB3 隔离恢复与 Migration Museum。build-authored checkpoint、播放 Auto/Skip、真实强杀、设备和 Windows/Android 宿主仍缺 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、[N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、三宿主 Golden |
