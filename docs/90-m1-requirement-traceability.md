...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E4 已完成 Compiler 图、10k 窗口、Canonical Layout 与交互；E5 P0 过滤 production browser 待复验；E6a/E6b 已实测选择性正文读取与无正文源文件 inventory，并纠正无验证缓存接入顺序。仍缺可内容校验/全量回退的 Compiler 派生缓存、Route catalog/window 产品接入、运行高亮、10k 局部编辑与 500 ms P95；角色/变量/覆盖过滤是 P1 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md)、[N40-E6b](159-n40-e6b-project-file-inventory-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E4 已证明 Compiler 自动图、10k 窗口、布局隔离和交互；E5 browser 待复验；E6a/E6b 只完成选择性读取与缓存失效前置 inventory。运行高亮、经验证的 Route 存储级接入和 N62 玩家自动图仍缺 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md)、[N40-E6b](159-n40-e6b-project-file-inventory-audit.md) |
