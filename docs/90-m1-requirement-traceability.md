...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E7 已完成 Compiler 图、10k 窗口、Layout/交互、缓存、局部编辑与 Runtime 路线高亮；E8a–E8j 建立 trusted Route-first、可保存 Script/Sequence、revision-bound 全局索引和 narration 最小结构闭环；E8k 已让 Route topology 只读取当前 scene/layout 页；E8l 完成指定结局候选路线和跨窗审阅；E8m 已完成 Compiler 诊断跨窗定位、精确 statement 聚焦、节点双击及 Choice/label 合法目标只读导航，10k 诊断定位 `2.18 ms <250 ms`，desktop/mobile production 通过。当前优先缺口是最小目标编辑/补全与修改后 Formal Runtime Preview 复核；Lazy Project 增量、外部目录与平台工作后置；角色/变量/覆盖过滤是 P1 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、[N40-E8a](164-n40-e8a-single-project-read-audit.md)–[N40-E8k](174-n40-e8k-trusted-route-topology-page-audit.md)、[N40-E8l](176-n40-e8l-ending-route-review-audit.md)、[N40-E8m](177-n40-e8m-diagnostic-navigation-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E8k 已建立自动图、窗口、缓存、Runtime 高亮、trusted Route-first、全局索引、narration 结构事务和 topology 分页；E8l 已让创作者沿指定结局候选跨窗审阅；E8m 已让正式 Compiler 诊断锚定 stable scene/statement，并提供节点双击及 Choice/label 目标导航，10k 定位 `2.18 ms <250 ms`。Route 驱动修改/保存/重建/Preview 闭环仍缺；完整 Lazy Project/增量 topology 后置，N62 玩家自动图未开始 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、[N40-E8a](164-n40-e8a-single-project-read-audit.md)–[N40-E8k](174-n40-e8k-trusted-route-topology-page-audit.md)、[N40-E8l](176-n40-e8l-ending-route-review-audit.md)、[N40-E8m](177-n40-e8m-diagnostic-navigation-audit.md) |
