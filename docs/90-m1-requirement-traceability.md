...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1/E2 已接入 History/Back/Forward 与手动 Save/Load；E3a 关闭 v2 元数据、strict v1、12 槽分页和 Host 截图 Blob；E3b 关闭 auto 5 / quick 1 与串行失败保留；E3c1 候选新增隔离恢复与五向量 Migration Museum。Skip、build-authored checkpoint、真实强杀、三端与真人证据仍缺 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、[N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1/E2 已贯通 History 与 Save/Load；E3a 关闭 strict v1 copy-on-write、12 槽与截图 Blob；E3b 已关闭 auto 5、quick 1、串行及失败保留；E3c1 候选建立 DB3 隔离恢复与 Migration Museum。build-authored checkpoint、播放 Auto/Skip、真实强杀、设备和 Windows/Android 宿主仍缺 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、[N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、三宿主 Golden |
...
| AC-07 | 三端结局/Save/Back 一致 | N31/N80–N82/N92 | 实现中 | Web 已证明 Session Save/load-only rehydrate、12 manual、auto 5、quick 1、v1→v2 兼容、截图 Blob 与隔离恢复；E3c1 Museum 冻结 current/legacy/future/corrupt 读取边界。Web 默认没有正式 compositor；build-authored checkpoint、真实强杀与三端 Host/设备仍未完成 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、[N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、三端 Session Save/Outcome Hash 0 差异 |
...
| AC-09 | 崩溃恢复到自动保存 | N12/N90/N91 | 实现中 | E3c1 候选已在 Web Player 建立与正式槽隔离的稳定边界恢复记录、显式恢复/清除和损坏 fail-closed；尚无真实浏览器/进程强杀、Windows/Android 正式宿主与设备矩阵，不能登记通过 | [N52-E3c1](243-n52-e3c1-recovery-migration-museum-audit.md)、真实强杀恢复矩阵 |
