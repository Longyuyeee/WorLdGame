...
| REQ-UX | 设计 Token、七模式、Beginner/Pro、统一语义、连续动效、60 FPS、减少动效、多模态状态 | N43/N101 | N21/N40–42 | 实现中 | N43-E1a 已冻结七模式身份并开放四种；E1b 关闭统一上下文保存重开，真实 Chrome 桌面/390px console 0、Preview `352×198`、横溢出 0。Beginner/Pro、完整七模式任务、减少动效/帧时间和真人证据仍未完成，N21 `0/1`、N23 `0/2` | [N43-E1b](204-n43-e1b-workspace-context-audit.md)、[N43-E1a](202-n43-e1-workspace-mode-foundation-audit.md)、[N21 执行包](114-n21-human-validation-execution-kit.md)、D1 任务报告 |
...
| AC-11 | 七模式修改同一语句 | N43 | 实现中 | N43-E1a 已冻结 7 个身份并开放 4 个；E1b 证明 Director 保存、整页重载、最近工程重开后仍恢复同一 Scene/Statement，Selection/Inspector/创作态 Runtime 零漂移。Production、Debug & QA、Mobile Focus 和七模式修改闭环仍未完成，当前仍是 4/7 | [N43-E1b](204-n43-e1b-workspace-context-audit.md)、[当前对齐审计](203-n43-e1-current-development-alignment-audit.md)、七模式 E2E |
