...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1 已让正式 Player Core 持有 N31 History Session，并接入可访问 Back/Forward、Host compensation/replay 与改选分支截断；Web 桌面/390×844 冷 production-browser 已通过。Save 槽位、Auto/Skip、Windows/Android 与真人证据仍缺 | [N52-E1](238-n52-e1-history-backed-player-core-audit.md)、[N31-E5](130-n31-e5-runtime-history-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1 已把 N31 History 和 Runtime Host reconciliation 接入同一正式 Player Core 与 Web Shell。持久 Save 槽位、Auto/Skip、真实设备和 Windows/Android 宿主仍缺 | [N52-E1](238-n52-e1-history-backed-player-core-audit.md)、[N50-E6](218-n50-e6-player-embed-api-audit.md)、三宿主 Golden |
