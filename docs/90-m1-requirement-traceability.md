...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E5 已关闭真实媒体 Stage、Move easing、基本关键帧、派生时间尺和两段 stable-ID Move 路径；E6 增加基础 Camera Move/Reset，并贯通 Canonical、Compiler、Runtime/Host、Canvas Preview 与保存重开。任意/贝塞尔路径、镜头高级效果、独立时间写入和模板仍缺 | [N42-E6](196-n42-e6-basic-camera-audit.md)、[N42-E5](195-n42-e5-character-motion-path-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b–E5 已证明真实 Stage、关键帧、时间尺与路径均由 stable-ID Script 驱动；E6 Camera 同样只保存 canonical `@camera`，刷新后由 Script 重建并由 Formal Runtime/Host 接管，没有第二套 Camera/Timeline 状态。完整时间写入和 N43 七模式仍未关闭 | [N42-E6](196-n42-e6-basic-camera-audit.md)、[N42-E5](195-n42-e5-character-motion-path-audit.md)、ChangeSet/Runtime 对照 |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | E2–E5 已让真实角色 Move、关键帧、派生时间尺和两段路径进入正式链；E6 关闭基础 Camera Move/Reset 的 Canonical→Runtime/Host→Canvas Preview→重开闭环。任意/贝塞尔路径、镜头高级效果、真实 Player 渲染/音频 Adapter 与三端媒体宿主仍缺 | [N42-E6](196-n42-e6-basic-camera-audit.md)、[N42-E5](195-n42-e5-character-motion-path-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、Media Golden 三端快照 |
