...
> 集成边界：当前开发链仍未进入 `main`；N00–N41 Authority 对应 main-target Draft PR #61，仍等待维护者审阅与合并。N40–N51 Engineering 出口不得换算成 Product Acceptance；**RA-N21-011 checkpoint 窄范围修订**只允许为 N52 checkpoint 修改 Story Language、Compiler、Runtime IR 与 Save schema，持续阻断 N52 Product Acceptance、N60 及以后、M1 Stable 与发布。N51 Engineering 已关闭；**N52-E3 入口契约**保持有效，N52-E1 History/Back/Forward、N52-E2 手动 Save/Load、**N52-E3a v2 元数据与截图**、**N52-E3b Auto / Quick Engineering 已关闭**、**N52-E3c1 Recovery / Migration Museum Engineering 已关闭**、**N52-E3c2 checkpoint 入口合同已关闭**、**N52-E3c3 checkpoint marker Engineering 已关闭**、N52-E3c4 Save v3 + 三 checkpoint 槽及 **N52-E4 Auto/Skip 入口合同**均已关闭。**N52-E4a Player Core Scheduler bridge** Engineering 已关闭。**N52-E4b Shell Auto real clock** 已有真实 clock/reveal/voice/suspend 与 cold production 证据，当前等待精确远端门；E4c 与 Product Acceptance 不变。
...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E4b 已把 Web Shell Auto 接到唯一 Core Scheduler，以真实 clock、文字揭示、voice duration/tail 和 suspend 工作；Skip、媒体/embed、三端与真人仍缺 | [N52-E4b](251-n52-e4b-shell-auto-real-clock-audit.md)、[N52-E4a](250-n52-e4a-player-core-scheduler-bridge-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1–E3c4 已关闭 History/Save/Recovery/checkpoint，E4a/E4b 已贯通 Core Scheduler 与 Web Shell Auto 真实计时/语音/suspend；Skip、媒体/embed、设备和 Windows/Android 宿主仍缺 | [N52-E4b](251-n52-e4b-shell-auto-real-clock-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、三宿主 Golden |
...
| AC-15 | Auto 和四种 Skip 正确 | N31/N52 | 实现中 | N52-E4b 已用 cold production Web 证明 Auto 的真实 clock、揭示、voice duration/tail、suspend/resume 和 terminal stop；四种 Skip、速度/媒体/embed、Windows/Android、实体设备与真人仍缺，不能登记产品通过 | [N52-E4b](251-n52-e4b-shell-auto-real-clock-audit.md)、[N52-E4a](250-n52-e4a-player-core-scheduler-bridge-audit.md)、玩家输入向量和 State Hash |
