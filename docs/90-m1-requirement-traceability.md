...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | N52-E1–E4c 已贯通 History/Save/Auto/Skip；E4c candidate 真实修正跨 budget 连续调度并公开 embed playback。完整 video、Stop Point source、设备和 Windows/Android 宿主仍缺 | [N52-E4c](252-n52-e4c-skip-media-embed-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md) |
