...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1 已在 Draft PR #52 通过未集成 Engineering；N32-E2 已在 Draft PR #53 run `32459445287` / job `96703241983` 用时 4 分 16 秒并通过完整门。N32-E3 已形成通过本地门与真实生产浏览器验证的 Engineering 候选，远端完整门待取得。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | E5/E6 已形成正式 History/调度，E10 补齐 reconciliation，E11 持久化完整 Session；E12 又使 Back/Forward 和旧 State/Session Save 对 read/CG/ending 只增，并通过真实浏览器与 Windows / Node 22 完整门。Player 控件、真实媒体宿主和三端证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、Editor/Player/三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1 已使 Editor 完整流程试玩消费 Compiler IR，E2 已增加状态与结构化诊断观察，E3 候选已从 Entry/Scene/Statement 构造合法 Fresh Run。仍缺 Preview 调试控制、共享 Player Host、玩家槽和真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E13](139-n31-e13-bounded-10k-step-audit.md)、[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)、[N32-E2](144-n32-e2-preview-session-observability-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、三宿主 Golden、玩家 E2E |
...
| REQ-QA | 任意入口运行、断点/单步、状态检查、结构错误、循环、源码跳转 | N30/N60 | N31/N32/N40 | 实现中 | Compiler 已有语句级 CFG/SCC 与 Statement Source Map；N31-E8 已精确映射结构化 Runtime Diagnostic；N32-E3 候选已支持 Scene/Statement Fresh Run，并对缺失目标、无效 Source Map 和直接 `return` 调用上下文给出明确诊断。断点、单步、Run to Cursor、Debugger/Solver 和完整产品呈现仍未实现 | [N30-E2 审计](124-n30-e2-compiler-completion-audit.md)、[N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、QA Golden、Debugger E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | E1 已证明 Entry 全流程由 Compiler→Runtime 执行；E2 已显示状态与结构化诊断；E3 候选已从 Scene/Statement 精确 Fresh Run 并恢复默认变量/空调用栈。仍缺需要既有调用上下文的任意位置调试状态、E4 控制、Debugger E2E 和产品验收，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)、[N32-E2](144-n32-e2-preview-session-observability-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、Debugger E2E |
...
| AC-16 | 每句 Back/Forward 和分支截断 | N31/N52 | 实现中 | E5 checkpoint/原子截断/tombstone、E10 reconciliation、E11 Session Save 继续有效；E12 在 Back/Forward 时确定性重链 checkpoint/entry，保持永久 Meta 只增并取得远端完整门绿色。玩家控制、真实媒体宿主、三端与真人证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、玩家 History E2E |
