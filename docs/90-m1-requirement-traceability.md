...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1 已让正式 Player Core 持有 N31 History Session，并接入可访问 Back/Forward、Host compensation/replay 与改选分支截断；N52-E2 又接入三个手动槽位、严格 Session Save 与跨刷新 Web IndexedDB Load。Auto/Skip、完整存档策略、Windows/Android 与真人证据仍缺 | [N52-E2](239-n52-e2-player-save-slots-audit.md)、[N52-E1](238-n52-e1-history-backed-player-core-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1 已把 N31 History 和 Runtime Host reconciliation 接入同一正式 Player Core 与 Web Shell，N52-E2 已增加三个持久手动 Save 槽位和 Load-only rehydrate。截图/分页、自动/快速/检查点、迁移、Auto/Skip、真实设备和 Windows/Android 宿主仍缺 | [N52-E2](239-n52-e2-player-save-slots-audit.md)、[N52-E1](238-n52-e1-history-backed-player-core-audit.md)、[N50-E6](218-n50-e6-player-embed-api-audit.md)、三宿主 Golden |
...
| AC-07 | 三端结局/Save/Back 一致 | N31/N80–N82/N92 | 实现中 | N52-E2 已把 N31 Session Save 接入同一 Player Core、三个手动槽位和独立 Web IndexedDB Host，证明跨刷新恢复 History/presentation、干净 Core exact State 与较新 Meta 单调合并，并以 rehydrate 禁止 Load 重放副作用；三端 Host/设备、截图、自动/快速槽、迁移与旧版本矩阵仍未完成 | [N52-E2](239-n52-e2-player-save-slots-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、三端 Session Save/Outcome Hash 0 差异 |
