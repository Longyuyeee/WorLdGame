...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1/E2 已接入 History/Back/Forward 与手动 Save/Load；E3a–E3c1 已关闭 v2 元数据/截图、auto/quick 与恢复；E3c3/E3c4 已贯通 build-authored marker、Save v3 与三 checkpoint 槽。Skip、真实强杀、三端与真人证据仍缺 | [N52-E3c4](247-n52-e3c4-save-v3-checkpoint-slots-audit.md)、[N52-E3c3](246-n52-e3c3-checkpoint-marker-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1/E2 已贯通 History 与 Save/Load；E3a–E3c4 已关闭 v2/v3 元数据、截图、auto/quick、恢复、build-authored marker 与 checkpoint 三槽。播放 Auto/Skip、真实强杀、设备和 Windows/Android 宿主仍缺 | [N52-E3c4](247-n52-e3c4-save-v3-checkpoint-slots-audit.md)、[N52-E3c3](246-n52-e3c3-checkpoint-marker-audit.md)、三宿主 Golden |
