...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1b 本地门已用真实 PNG/WAV 关闭 16:9 Canvas 点击、stable-ID patch、s1 重开、Canonical 资源桥与 Runtime Host：production 实际 75/45、Host 1 active、0 diagnostics、console 0 error/warn；全仓 740/740、storage 1/1、VM 5/5。等待 E1b Windows CI；多轨、关键帧、镜头、模板仍缺 | [N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N42-E1a](187-n42-e1-stage-director-placement-audit.md)、[N22 退出审计](113-n22-exit-condition-audit.md)、AC-13 |
