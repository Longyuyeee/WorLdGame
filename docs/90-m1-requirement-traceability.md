...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | N22 已有真实 Blob 预览、角色几何、安全区、DPR、触摸/键盘选择及媒体错误隔离；仍缺视觉 Golden、正式渲染宿主、镜头/关键帧/UI 模板与 Runtime 同步 | Media Golden、视觉 Golden、AC-13 |
