...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E4 已完成 Compiler 图、10k 窗口、Layout/交互；E5 browser 待复验；E6a–E6d 已完成可校验缓存基础及 Launcher/Route 接入；E6e 实测 10k 局部编辑 20 样本 P95 `64.10 ms`；E7 已把 Formal Runtime History 的当前/已访问场景和精确 choice edge 投影到 Flow，并实测 Back/Forward 与 64 节点窗口回锚。仍缺冷启动正文局部读取及 production browser 复验；角色/变量/覆盖过滤是 P1 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md)、[N40-E6b](159-n40-e6b-project-file-inventory-audit.md)、[N40-E6c](160-n40-e6c-verified-compiler-cache-audit.md)、[N40-E6d](161-n40-e6d-launcher-route-cache-integration-audit.md)、[N40-E6e](162-n40-e6e-route-edit-sync-performance-audit.md)、[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E6e 已证明 Compiler 自动图、10k 窗口、布局、过滤、可校验缓存和 `<500 ms` 局部编辑；E7 已证明 Formal Runtime 当前/访问/choice edge 高亮及 Back/Forward/跨窗口回锚。真正存储级正文局部读取、production browser 和 N62 玩家自动图仍缺 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md) |
