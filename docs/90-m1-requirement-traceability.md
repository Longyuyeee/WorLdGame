...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E4 已关闭真实媒体 Stage、Move easing、基本关键帧和派生时间尺；E5 又以一次 canonical batch 生成两段 stable-ID Move 路径，保存重开、Runtime/Host 与 Preview 同语义。真实工程为 9 步、6.320s；10k 路径规划 43.14ms。任意曲线、独立时间写入、镜头和模板仍缺 | [N42-E5](195-n42-e5-character-motion-path-audit.md)、[N42-E4](194-n42-e4-derived-timeline-playhead-audit.md)、[N42-E3](190-n42-e3-character-keyframe-authoring-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b–E4 已证明真实 Stage、关键帧与时间尺均由 stable-ID Script 驱动；E5 路径也只原子生成两个 canonical Move，刷新后由 Script 重建并由 Formal Runtime Source Map 逐段接管，没有第二套 Path/Timeline 持久状态。完整时间线和 N43 七模式仍未关闭 | [N42-E5](195-n42-e5-character-motion-path-audit.md)、[N42-E4](194-n42-e4-derived-timeline-playhead-audit.md)、ChangeSet/Runtime 对照 |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | E2–E4 已让真实角色 Move、下一关键帧和派生多轨时间尺进入正式链；E5 又关闭两段折线路径的 Canonical→Runtime/Host→Preview→重开闭环。任意/贝塞尔路径、镜头、真实 Player 渲染/音频 Adapter 与三端媒体宿主仍缺 | [N42-E5](195-n42-e5-character-motion-path-audit.md)、[N42-E4](194-n42-e4-derived-timeline-playhead-audit.md)、[N42-E3](190-n42-e3-character-keyframe-authoring-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、Media Golden 三端快照 |
