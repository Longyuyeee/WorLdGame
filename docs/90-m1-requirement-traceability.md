...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | N22 已有真实 Blob 预览、角色几何、安全区、DPR、输入等价、媒体错误隔离、Render Host v1 及真实 PNG/WAV Media Golden 运行链；仍缺浏览器交互与像素视觉 Golden，Canvas/Pixi 高性能后端、镜头/关键帧/UI 模板与 Runtime 同步归后续节点 | 浏览器 Media Golden、视觉 Golden、AC-13 |
