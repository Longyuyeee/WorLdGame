...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E7 已关闭真实媒体 Stage、Move easing、基本关键帧、派生时间尺、两段 stable-ID Move 路径、基础 Camera 与作用域转场；E8 候选冻结 ADV/NVL/Bubble 文本模板，贯通 canonical、Compiler、Runtime/Host、TEXT lane、Preview 与重开，NVL 实际累积且有 8 行上限。任意/贝塞尔路径、镜头高级效果、独立时间写入和正式 Player 一致性仍缺 | [N42-E8](198-n42-e8-dialogue-presentation-templates-audit.md)、[N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、AC-13 |
