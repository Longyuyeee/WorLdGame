...
| REQ-UX | 设计 Token、七模式、Beginner/Pro、统一语义、连续动效、60 FPS、减少动效、多模态状态 | N43/N101 | N21/N40–42 | 实现中 | N42-E3a 已修正首页原生控件、内部 fixture 抢占首层和桌面整页纵向摊大饼：1280×720 实测 Shell/Document 均为 720 px，中央与 Preview 独立滚动，舞台保持 1.778；仍仅三模式，Stage/Runtime/Build 渐进展开、七模式和真人证据未完成，N21 `0/1`、N23 `0/2` | [N42-E3a UI 审计](192-n42-e3a-ui-shell-convergence-audit.md)、[N23-E7 审计](122-n23-e7-acceptance-launcher-audit.md)、[N21 执行包](114-n21-human-validation-execution-kit.md)、[N23 执行包](121-n23-product-acceptance-execution-kit.md)、D1 任务报告 |
