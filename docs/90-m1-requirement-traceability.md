...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E6 已关闭真实媒体 Stage、Move easing、基本关键帧、派生时间尺、两段 stable-ID Move 路径与基础 Camera；E7 冻结 `fade/dissolve/slide`，补齐背景替换/清除的 canonical、资源窗口、Runtime/Host、分层 Canvas Preview 与保存重开闭环，并由干净 Windows 完整门关闭本机性能差异。任意/贝塞尔路径、镜头高级效果、独立时间写入和模板仍缺 | [N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、[N42-E6](196-n42-e6-basic-camera-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b–E6 已证明真实 Stage、关键帧、时间尺、路径与 Camera 均由 stable-ID Script 驱动；E7 转场同样只保存 canonical `transition/duration`，资源窗口、Formal Runtime/Host 与 Preview 均由 Script 重建，没有第二套 Transition/Timeline 状态。完整时间写入和 N43 七模式仍未关闭 | [N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、[N42-E6](196-n42-e6-basic-camera-audit.md)、ChangeSet/Runtime 对照 |
