...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | E4 Engineering `完整 7 / 阻断 0`：作者 Stop Point、正式 video、Auto 与四种 Skip 的桌面/390×844 Web 证据闭环；三端正式宿主、实体设备、真人和 N52 Product Acceptance 仍缺 | [N52-E4f 出口](257-n52-e4f-mobile-cold-production-and-e4-exit-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | N52 Web Engineering 已贯通 History/Save/Back/Forward、Auto、四种 Skip、作者 Stop Point 与正式 video policy；仍缺 N52 总出口复审、Windows/Android 正式宿主、实体设备和真人 Product Acceptance | [N52-E4f](257-n52-e4f-mobile-cold-production-and-e4-exit-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md) |
