...
| REQ-GAL | 可搜索设置、继承/撤销/预览、完整 Gal P0、附加页模板、六类音量、三平台 Profile | N51/N52/N62 | N10/N31/N50/N51 | 实现中 | E1/E2 已建立首批 23 字段、三层继承/来源、确定性序列化、Basic/Advanced catalog、双语搜索和原子分层编辑；UI、Project 事务、热预览及剩余 P0 未完成 | [范围消歧 #220](220-n50-n52-scope-reconciliation.md)、[N51 治理 #221](221-n50-n51-governance-checkpoint.md)、[N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、[N51-E2 #223](223-n51-e2-settings-catalog-editor-audit.md)、Settings UI/E2E |
