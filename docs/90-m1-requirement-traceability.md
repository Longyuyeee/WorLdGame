...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E4a 已把正式 N31 Scheduler 接入 Player Core，具有 canonical policy、Forward History 停止、checkpoint/Host bridge 和结构化 stop snapshot；Shell Auto/Skip、真实强杀、三端与真人证据仍缺 | [N52-E4a](250-n52-e4a-player-core-scheduler-bridge-audit.md)、[N52-E4 入口](249-n52-e4-auto-skip-entry-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1–E3c4 已关闭 History、存档、恢复与 checkpoint。N52-E4 Auto/Skip 入口合同冻结唯一 Scheduler、Core/Shell/Host 所有权和停止规则；Player bridge、真实计时/媒体、设备和 Windows/Android 宿主仍缺 | [N52-E4 入口](249-n52-e4-auto-skip-entry-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、三宿主 Golden |
...
| AC-15 | Auto 和四种 Skip 正确 | N31/N52 | 实现中 | N52-E4a 已接入唯一 Scheduler，并实测 Auto boundary/delay、Stop Point、Forward History、checkpoint 与 resourceUnavailable；Shell 真实 clock/voice、Skip 控件/媒体/embed、三端与真人仍缺，不能登记产品通过 | [N52-E4a](250-n52-e4a-player-core-scheduler-bridge-audit.md)、[N31-E6 审计](131-n31-e6-runtime-scheduler-audit.md)、玩家输入向量和 State Hash |
