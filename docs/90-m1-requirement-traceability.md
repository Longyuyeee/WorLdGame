...
| REQ-L10N | 语言、稳定文本 ID、CSV/XLSX、状态、运行切换、CJK/Ruby | N61 | N10/N30/N50 | 实现中 | N61-E1–E6 已完成文本生产/交换、Player 即时切换、CJK/Ruby/字体回退、语言媒体/Voice 消费，以及 Production 绑定、状态和保存重开；仍缺 E7 同一 Canonical 跨 Editor/Compiler/Player 交付、E4 移动排版实测和三端实体一致性 | [N61-E6 审计](279-n61-e6-localized-media-production-audit.md)、[N61-E5 审计](278-n61-e5-localized-media-voice-mapping-audit.md)、三端语言切换 |
