...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1 已在 Draft PR #52 通过未集成 Engineering；N32-E2 已在 Draft PR #53 通过；N32-E3 已在 Draft PR #54 run `32461345815` / job `96708731870` 用时 4 分 16 秒并通过完整门，记录为未集成 Engineering 通过。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1 已使 Editor 完整流程试玩消费 Compiler IR，E2 已增加状态与结构化诊断观察，E3 已从 Entry/Scene/Statement 构造合法 Fresh Run。仍缺 Preview 调试控制、共享 Player Host、玩家槽和真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E13](139-n31-e13-bounded-10k-step-audit.md)、[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)、[N32-E2](144-n32-e2-preview-session-observability-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、三宿主 Golden、玩家 E2E |
