...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E4 已完成 Compiler 图、10k 有界窗口、Canonical Layout 与可访问交互；E5 已形成 P0 组合过滤候选但 production browser 待复验；E6a 已用 Web 读取计数和 Node 真实目录/联接证明宿主可安全选择性读取，但尚未接入 Route 打开/换窗。仍缺存储级 Route catalog/window 集成、运行路线高亮、10k 局部编辑与端到端 500 ms P95；角色/变量/覆盖过滤是 P1 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md)、跨视图 E2E |
...
| AC-04 | 任一视图修改 500 ms 同步 | N43 | 实现中 | E2 已测 10k 图索引与局部查询，但没有测量 Script/Project Service 修改后的端到端重编译与渲染 P95；视图也未齐 | [N40-E2](154-n40-e2-10k-route-window-audit.md)、P95 测量和 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E4 已证明 Compiler 自动图、10k 有界窗口、布局隔离和可访问交互；E5 P0 过滤候选自动化通过但 production browser 待复验；E6a 只完成安全选择性读取 adapter。运行高亮、Route 存储级接入和 N62 玩家自动图仍缺 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md) |
