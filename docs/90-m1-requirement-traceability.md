...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N50-E1 已建立 portable Player Core 和最小共享 Shell，Benchmark/Branching 只经正式 Compiler/Runtime/Host 到达对白、选择与结局，错误工程 fail closed，production browser 指针/键盘双路线通过。旧单文件试玩仍是独立 `StoryStatement` 候选，不是本 Player；玩家槽、历史/控制 UI、媒体 Adapter、视觉差分和三端宿主仍缺 | [N50-E1](212-n50-e1-formal-player-core-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、三宿主 Golden、玩家 E2E |
