...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1–E5 已在 Draft PR #52–#56 通过未集成 Engineering；N32-E6 已完成本地实现、自动化与 production browser 候选验证，等待 Draft PR 的 Windows / Node 22 完整门。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1–E5 已完成正式执行、观察、Fresh Run、调试控制与 Effect Host；E6 候选已实现记录输入重放的安全文案热更新，以及语义变化/待决工作/编译失败的显式重启。仍缺共享 Player Host、玩家槽和三端真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E6](148-n32-e6-preview-hot-update-audit.md)、三宿主 Golden、玩家 E2E |
...
| REQ-QA | 任意入口运行、断点/单步、状态检查、结构错误、循环、源码跳转 | N30/N60 | N31/N32/N40 | 实现中 | Compiler/Runtime 已有 CFG/SCC、Source Map 与结构化诊断；N32-E3–E5 已支持 Fresh Run、调试控制与 Effect/History Host 边界；E6 候选对可迁移和必须重启的编辑给出可审计产品反馈。仍缺断点管理、Watch、Solver 和完整 Debugger E2E | [N30-E2 审计](124-n30-e2-compiler-completion-audit.md)、[N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)–[N32-E6](148-n32-e6-preview-hot-update-audit.md)、QA Golden、Debugger E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | E1–E5 已完成正式执行、状态观察、Fresh Run、调试控制与 Editor Effect/Barrier Host；E6 候选补上受约束热更新与结构变化显式重启。仍缺断点/Watch、共享 Player Host、完整 Debugger E2E 和产品验收，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E6](148-n32-e6-preview-hot-update-audit.md)、Debugger E2E |
