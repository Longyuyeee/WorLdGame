...
| REQ-GAL | 可搜索设置、继承/撤销/预览、完整 Gal P0、附加页模板、六类音量、三平台 Profile | N51/N52/N62 | N10/N31/N50/N51 | 实现中 | E1/E2 已建立首批 23 字段、三层继承/来源、确定性序列化、Basic/Advanced catalog、双语搜索和原子分层编辑；UI、Project 事务、热预览及剩余 P0 未完成，E3–E6 顺序与真实测试要求已冻结 | [范围消歧 #220](220-n50-n52-scope-reconciliation.md)、[N51 治理 #221](221-n50-n51-governance-checkpoint.md)、[N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、[N51-E2 #223](223-n51-e2-settings-catalog-editor-audit.md)、[暂停检查点 #224](224-n51-e2-pause-and-next-step-checkpoint.md)、Settings UI/E2E |
...
| AC-19 | Gal 配置中心覆盖 P0 | N51 | 实现中 | E1/E2 覆盖首批 23 字段、三层来源、Basic/Advanced、搜索和编辑事务；完整字段、UI 与 Preview/Player 应用仍缺 | [N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、[N51-E2 #223](223-n51-e2-settings-catalog-editor-audit.md)、配置追踪全覆盖 |
