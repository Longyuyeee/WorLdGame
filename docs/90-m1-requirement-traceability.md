...
| REQ-GAL | 可搜索设置、继承/撤销/预览、完整 Gal P0、附加页模板、六类音量、三平台 Profile | N51/N52/N62 | N10/N31/N50/N51 | 实现中 | E1 已建立首批 23 字段、default/project/platform 继承与来源、当前层 reset、严格解析和确定性序列化；UI、Project 事务、热预览及剩余 P0 未完成 | [范围消歧 #220](220-n50-n52-scope-reconciliation.md)、[N51 治理 #221](221-n50-n51-governance-checkpoint.md)、[N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、Settings UI/E2E |
...
| AC-19 | Gal 配置中心覆盖 P0 | N51 | 实现中 | E1 typed core 覆盖首批 23 字段及三层来源；完整字段、UI 与 Preview/Player 应用仍缺 | [N51-E1 #222](222-n51-e1-typed-gal-settings-core-audit.md)、配置追踪全覆盖 |
