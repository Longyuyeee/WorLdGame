...
| REQ-SEQ | P0 语句块、排序/复制/批量/折叠、Inspector、跨视图定位 | N21/N41 | N21 | 实现中 | 完整工程已有全部 P0 卡片、类型化 Inspector、搜索、复制/移动/批量/折叠；E8g–E8j 有 Route-first 投影、索引与 narration 结构事务。N41-E1 已把原 Writer 正式统一为 Sequence；E2 的 1,000 次全 P0 Sequence/Script 交替互改、choice child、stable ID、format/hash 和四类失败关闭门已由 PR #62 Windows CI 关闭。仍缺更多 lazy 结构族、N21 真人、N41 完整出口与 Product Acceptance | [N41-E1](181-n41-e1-formal-sequence-mode-audit.md)、[N41-E2](183-n41-e2-sequence-script-scale-audit.md)、[N40-E8g](170-n40-e8g-lazy-sequence-projection-audit.md)–[N40-E8j](173-n40-e8j-lazy-narration-structure-flow-audit.md)、[N21 真人执行包](114-n21-human-validation-execution-kit.md) |
