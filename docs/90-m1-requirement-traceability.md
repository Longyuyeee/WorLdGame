...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1–E6 已在 Draft PR #52–#57 通过未集成 Engineering；E6 实现头 `34dfbf1` 的 Windows / Node 22 完整门 run `32470326283` / job `96735561264` 用时 4 分 20 秒并绿色。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1–E5 已完成正式执行、观察、Fresh Run、调试控制与 Effect Host；E6 已实现记录输入重放的安全文案热更新，以及语义变化/待决工作/编译失败的显式重启。仍缺共享 Player Host、玩家槽和三端真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E6](148-n32-e6-preview-hot-update-audit.md)、三宿主 Golden、玩家 E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | E1–E5 已完成正式执行、状态观察、Fresh Run、调试控制与 Editor Effect/Barrier Host；E6 补上受约束热更新与结构变化显式重启。仍缺断点/Watch、共享 Player Host、完整 Debugger E2E 和产品验收，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E6](148-n32-e6-preview-hot-update-audit.md)、Debugger E2E |
