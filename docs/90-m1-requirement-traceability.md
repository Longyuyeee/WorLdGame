...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E8k 已建立自动图、窗口、缓存、Runtime 高亮、trusted Route-first、全局索引、narration 结构事务和 topology 分页；E8l 已让创作者选择结局、切换确定性候选并沿 stable scene/edge 跨窗审阅，10k 查询 `13.29 ms <250 ms`。诊断定位和 Route 驱动修复闭环仍缺；完整 Lazy Project/增量 topology 后置，N62 玩家自动图未开始 | [N40-E1](153-n40-e1-route-graph-core-audit.md)–[N40-E7](163-n40-e7-runtime-route-highlight-audit.md)、[N40-E8a](164-n40-e8a-single-project-read-audit.md)–[N40-E8k](174-n40-e8k-trusted-route-topology-page-audit.md)、[N40-E8l](176-n40-e8l-ending-route-review-audit.md) |
