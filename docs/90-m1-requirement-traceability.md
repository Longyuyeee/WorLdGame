...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1–E3 已在 Draft PR #52–#54 通过未集成 Engineering；N32-E4 已形成通过本地门与真实 production browser 验证的候选，远端完整门待取得。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N31 已形成正式 History/调度/reconciliation/Session Save/永久 Meta；N32-E4 候选已把 Back/Forward、Continue、Step Over 和 Run to Cursor 接入 Editor 产品入口。真实媒体 Host、Player 控件和三端证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、[N32-E4](146-n32-e4-preview-debug-controls-audit.md)、Editor/Player/三端状态一致 |
...
| REQ-QA | 任意入口运行、断点/单步、状态检查、结构错误、循环、源码跳转 | N30/N60 | N31/N32/N40 | 实现中 | Compiler/Runtime 已有 CFG/SCC、Source Map 与结构化诊断；N32-E3 已支持目标 Fresh Run，E4 候选又支持 Continue、Step Over、Back/Forward 与执行前 Run to Cursor。仍缺断点管理、Watch、Effect Host 协调、Solver 和完整 Debugger E2E | [N30-E2 审计](124-n30-e2-compiler-completion-audit.md)、[N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、[N32-E4](146-n32-e4-preview-debug-controls-audit.md)、QA Golden、Debugger E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | E1–E3 已完成正式执行、状态观察和 Scene/Statement Fresh Run；E4 候选已支持内部指令执行前 Run to Cursor、Step Over 与 History 导航。仍缺断点/Watch、Effect Host、完整 Debugger E2E 和产品验收，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)、[N32-E2](144-n32-e2-preview-session-observability-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)、[N32-E4](146-n32-e4-preview-debug-controls-audit.md)、Debugger E2E |
...
| AC-16 | 每句 Back/Forward 和分支截断 | N31/N52 | 实现中 | 正式 Runtime checkpoint/截断/tombstone/reconciliation/Session Save/永久 Meta 保持有效；N32-E4 候选已在 Editor UI 验证 Back/Forward、transient 回退、同选择重放与改选原子 fork。真实媒体 Host、Player/三端和真人证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、[N32-E4](146-n32-e4-preview-debug-controls-audit.md)、玩家 History E2E |
