...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E4 已完成 Compiler 图、10k 有界窗口、Canonical Layout 与可访问交互；E5 已形成章节/节点类型/视觉分组 P0 组合过滤候选，自动化和构建通过但 production browser 因管理员安全校验待复验。仍缺宿主/磁盘级按需读取、运行路线高亮、10k 局部编辑与端到端 500 ms P95；按角色/变量/覆盖过滤是 P1，不计入 N40 P0 关闭条件 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、跨视图 E2E |
...
| AC-17 | 脚本自动生成创作者 Route | N40/N62 | 实现中 | E1–E4 已证明 Compiler 自动图、10k 有界窗口、布局隔离和可访问交互；E5 P0 过滤候选自动化通过但 production browser 待复验。运行高亮、宿主/磁盘级按需读取和 N62 玩家自动图仍缺 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md) |
