...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线已在 Draft PR #51 的 Windows / Node 22 完整门（run `32352341550` / job `96374022660`）绿色后成为 Authoritative。N22 与 N23-E1–E7 工程门已完成，N30-E1/E2 Compiler 为未集成工程退出候选；N31-E1–E14 已通过未集成的 Engineering 出口。N32-E1 已在 Draft PR #52 的 Windows / Node 22 完整门（run `32455301058` / job `96691329961`）绿色后通过未集成 Engineering；`RA-N21-004` 不改变 N21/N23/N30/N31 产品验收，也持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1 已使 Editor 完整流程试玩消费 Compiler IR 并经正式 Runtime 执行，双路线 State Hash 与生产浏览器结局符合冻结预期，编译错误 fail closed。仍缺 Preview 状态检查/调试控制、共享 Player Host、玩家槽和真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E13](139-n31-e13-bounded-10k-step-audit.md)、[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)、三宿主 Golden、玩家 E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | N32-E1 已证明 Entry 全流程由 Compiler→Runtime 执行，并用 Source Map 精确回到当前 Statement；尚未实现 Run from Scene/Statement、变量/调用栈检查器与 Debugger UI，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1 审计](142-n32-e1-formal-editor-preview-audit.md)、Debugger E2E |
