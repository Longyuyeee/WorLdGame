...
> 集成边界：当前 N00–N21 能力仍未进入 `main`；[M1 N21 指定集成基线](101-m1-n21-integration-baseline.md)已在 Draft PR #32 成为 Authoritative。N22 与 N23-E1–E7 工程门已完成，N30-E1/E2 Compiler 为未集成工程退出候选；N31-E1–E11 为未集成工程切片，E9 出口审计仍未通过。`RA-N21-003` 不改变 N21/N23/N30/N31 产品验收与 M1 仍被阻断，也不授权 N32。
...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N31-E5/E6 已形成正式 History 与调度；E10 补齐 reconciliation；E11 又将完整 History/Cursor/checkpoint/tombstone 纳入 canonical Session Save，Node 与浏览器 Runtime Worker Golden 一致。Meta Progress 仍会随剧情 checkpoint Back 回退；Player 控件、真实媒体宿主协调、远端完整门和三端证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、Editor/Player/三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | N31-E11 已补齐 VM-11 Session Save 的正式实现，并通过浏览器 Runtime Golden 与 Windows / Node 22 完整门。VM-13 monotonic Meta、VM-14 10k-step 仍阻断出口，玩家槽、真实媒体策略和共享 Editor/Player 也仍未建立 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E10](135-n31-e10-formal-vm-parity-audit.md)、[E11](137-n31-e11-runtime-session-save-audit.md)、三宿主 State/Save/History/Diagnostic Golden、玩家 E2E |
...
| AC-07 | 三端结局/Save/Back 一致 | N31/N80–N82/N92 | 实现中 | E11 已建立独立 canonical Session Save，Load 后恢复同一 Cursor、完整 Back/Forward 链、未来记录和 tombstone，并进入 Node/浏览器 Runtime Golden。Meta Progress 仍会随剧情 checkpoint 回退；远端完整门、E12、三端 Player、设备与存档槽均未完成 | [N31-E4](129-n31-e4-runtime-save-load-audit.md)、[N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、三端 Session Save/Outcome Hash 0 差异 |
...
| AC-16 | 每句 Back/Forward 和分支截断 | N31/N52 | 实现中 | N31-E5 的 checkpoint、原子截断、tombstone 与 Barrier Golden 有效；E10 已输出 reconciliation plan；E11 已证明 Session Save 后 Cursor、未来记录、tombstone 与 Back/Forward State Hash 保持一致。完整 checkpoint 仍会回退 Meta Progress；远端完整门、E12、玩家控制、真实媒体宿主执行、三端与真人证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、玩家 History E2E |
