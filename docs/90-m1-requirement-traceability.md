...
| REQ-L10N | 语言、稳定文本 ID、CSV/XLSX、状态、运行切换、CJK/Ruby | N61 | N10/N30/N50 | 实现中 | N61-E1–E4 已完成功能生产/交换、Player 即时语言切换、缺失/过期回退、语义 Ruby、严格 CJK 排版合同和项目字体失败回退；仍缺 E4 双视口实际断行闭环、语言媒体/Voice Asset 和三端实体一致性 | [N61-E4 审计](277-n61-e4-cjk-ruby-font-fallback-audit.md)、[N61-E3 审计](276-n61-e3-runtime-localization-switch-audit.md)、三端语言切换 |
