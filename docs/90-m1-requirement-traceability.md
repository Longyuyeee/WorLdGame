...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1 Engineering 已用真实 PNG/WAV 关闭 16:9 Canvas 点击、stable-ID patch、s1 重开、Canonical 资源桥与 Runtime Host：production 实际 75/45、Host 1 active、0 diagnostics、console 0 error/warn；本地 740/740、storage 1/1、VM 5/5，Draft PR #67 Windows CI 5 分 53 秒绿色。多轨、关键帧、镜头、模板仍缺 | [N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N42-E1a](187-n42-e1-stage-director-placement-audit.md)、[N22 退出审计](113-n22-exit-condition-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b 已在 production browser 证明真实 PNG Stage 点击生成同一 stable-ID Script patch，s1 重开与正式 Runtime Host 均保持 75/45；完整时间线和 N43 七模式仍未关闭 | [N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N41 出口复审](185-n41-engineering-exit-reaudit.md)、ChangeSet/Hash 对照 |
