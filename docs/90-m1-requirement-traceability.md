...
| USP-03 | Narrative Intelligence | N30/N60 | 实现中 | N30 Compiler 已有语句级 CFG/SCC、结构/资源/表达式诊断与 Source Map；N60-E1/E2 已把正式 Runtime 调试入口、单步/历史、状态观察器、多断点集合与六类停止原因接入 Debug & QA。Watch、变量来源、Solver 和完整 QA 报告仍缺 | [N60-E2](268-n60-e2-breakpoint-boundary-audit.md)、[N60-E1](267-n60-e1-debugger-session-audit.md)、[N30-E2](124-n30-e2-compiler-completion-audit.md)、QA Golden |
...
| REQ-QA | 任意入口运行、断点/单步、状态检查、结构错误、循环、源码跳转 | N30/N60 | N31/N32/N40 | 实现中 | Compiler/Runtime 已有 CFG/SCC、Source Map 与结构化诊断；N60-E1/E2 已提供 Entry/当前语句启动、Back/Forward/Step/Step Over/Continue、多断点启停/移除、六类停止原因、变量/栈/可见 Host 状态与源码返回。仍缺 Watch、变量来源、Solver、覆盖率和完整 QA 报告 | [N60-E2](268-n60-e2-breakpoint-boundary-audit.md)、[N60-E1](267-n60-e1-debugger-session-audit.md)、[N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、QA Golden |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | Editor 正式执行、Fresh Run、Effect/Barrier Host 与安全热更新已完成；N60-E1/E2 已提供当前语句启动、多断点、当前源码/变量/栈/可见对象、调试历史和正式边界原因 UI。仍缺 Watch/变量来源、完整 Debugger E2E、像素视觉矩阵与产品验收 | [N60-E2](268-n60-e2-breakpoint-boundary-audit.md)、[N60-E1](267-n60-e1-debugger-session-audit.md)、[N50-E6](218-n50-e6-player-embed-api-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md) |
