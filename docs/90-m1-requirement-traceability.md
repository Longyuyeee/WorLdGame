...
| REQ-ROUTE | 完整自动图、布局、局部加载、诊断、路线高亮、进入 Sequence | N40 | N20/N30 | 实现中 | E1–E4 已完成 Compiler 图、10k 窗口、Layout/交互；E5 browser 待复验；E6a–E6d 已完成可校验缓存基础及 Launcher/Route 接入；E6e 已实测 10k 单场景 Project Service 修改到 Route 查询窗口的 20 样本 P95 `64.10 ms`，并把未保存的 Route/Sequence/Script 局部动作接入权威增量分析。仍缺冷启动正文局部读取、运行高亮及 browser 复验；角色/变量/覆盖过滤是 P1 | [N40-E1](153-n40-e1-route-graph-core-audit.md)、[N40-E2](154-n40-e2-10k-route-window-audit.md)、[N40-E3](155-n40-e3-route-layout-sidecar-audit.md)、[N40-E4](156-n40-e4-route-layout-interaction-audit.md)、[N40-E5](157-n40-e5-route-filtering-audit.md)、[N40-E6a](158-n40-e6a-selective-project-read-audit.md)、[N40-E6b](159-n40-e6b-project-file-inventory-audit.md)、[N40-E6c](160-n40-e6c-verified-compiler-cache-audit.md)、[N40-E6d](161-n40-e6d-launcher-route-cache-integration-audit.md)、[N40-E6e](162-n40-e6e-route-edit-sync-performance-audit.md)、跨视图 E2E |
