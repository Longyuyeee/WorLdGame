...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1 已用真实 PNG/WAV 关闭 16:9 Canvas 点击、s1 重开、Canonical 资源桥与 Runtime Host；E2 又冻结 4 种 Move easing 并贯通图形化编辑、Script、CSS 语义 Canvas/DOM、重开与正式 Runtime。production 实际 `ease-out`、X=25/Y=80/800ms、Host 1 active、0 diagnostics、console `[]`；本地总计 749/749。多轨、关键帧、路径、镜头、模板仍缺 | [N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N42-E1a](187-n42-e1-stage-director-placement-audit.md)、[N22 退出审计](113-n22-exit-condition-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b 已证明真实 PNG Stage 点击生成 stable-ID Script patch；E2 证明 Move easing 从 Sequence 改为 `ease-out` 后 Script r1、s1 重开、Canvas/DOM 与正式 Runtime Host 同源。完整时间线和 N43 七模式仍未关闭 | [N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N42-E1b](188-n42-e1b-production-media-stage-audit.md)、[N41 出口复审](185-n41-engineering-exit-reaudit.md)、ChangeSet/Hash 对照 |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | E2 已让真实角色 Move 的几何、800ms 与 4 种 easing 进入 Canvas/DOM 和正式 Runtime Effect Host；现有 portable Host execute/complete/cancel/compensate/replay 保持。复杂镜头、关键帧、路径、真实 Player 渲染/音频 Adapter 与三端媒体宿主仍缺 | [N42-E2](189-n42-e2-stage-move-easing-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、Media Golden 三端快照 |
