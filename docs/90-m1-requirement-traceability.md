...
> 集成边界：当前 N00–N21 能力仍未进入 `main`；[M1 N21 指定集成基线](101-m1-n21-integration-baseline.md)已在 Draft PR #32 成为 Authoritative。N22 与 N23-E1–E7 工程门已完成，N30-E1/E2 Compiler 为未集成工程退出候选；N31-E1–E12 为未集成工程切片，E12 远端完整门与 E14 出口审计仍未完成。`RA-N21-003` 不改变 N21/N23/N30/N31 产品验收与 M1 仍被阻断，也不授权 N32。
...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | E5/E6 已形成正式 History/调度，E10 补齐 reconciliation，E11 持久化完整 Session；E12 又使 Back/Forward 和旧 State/Session Save 对 read/CG/ending 只增，并通过真实浏览器完整 Worker Golden。E12 远端支持版本门、Player 控件、真实媒体宿主和三端证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、Editor/Player/三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E11 已关闭 VM-11；E12 的独立 Meta boundary 已通过 Node 定向和真实浏览器完整 Worker 门，VM-13 等待远端支持版本复验后关闭。VM-14 10k-step、玩家槽、真实媒体策略和共享 Editor/Player 仍未建立 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E10](135-n31-e10-formal-vm-parity-audit.md)、[E11](137-n31-e11-runtime-session-save-audit.md)、[E12](138-n31-e12-monotonic-meta-audit.md)、三宿主 State/Save/History/Diagnostic Golden、玩家 E2E |
...
| AC-16 | 每句 Back/Forward 和分支截断 | N31/N52 | 实现中 | E5 checkpoint/原子截断/tombstone、E10 reconciliation、E11 Session Save 继续有效；E12 在 Back/Forward 时确定性重链 checkpoint/entry，并保持永久 Meta 只增。E12 远端完整门、玩家控制、真实媒体宿主、三端与真人证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E10](135-n31-e10-formal-vm-parity-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、[N31-E12](138-n31-e12-monotonic-meta-audit.md)、玩家 History E2E |
