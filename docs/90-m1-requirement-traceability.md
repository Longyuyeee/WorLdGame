...
> 集成边界：当前 N00–N21 能力仍未进入 `main`；[M1 N21 指定集成基线](101-m1-n21-integration-baseline.md)已在 Draft PR #32 成为 Authoritative。N22 与 N23-E1–E7 工程门已完成，N30-E1/E2 Compiler 为未集成工程退出候选；N31-E1–E13 为未集成工程切片，VM-11/13 已关闭，VM-14 远端复验与 E14 出口审计仍未完成。`RA-N21-003` 不改变 N21/N23/N30/N31 产品验收与 M1 仍被阻断，也不授权 N32。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E11/E12 已关闭 VM-11/13；E13 已建立正式 10,000 次单流程、128 指令有界批次和 Node/浏览器三域 Golden，VM-14 等待远端支持版本门后关闭。玩家槽、真实媒体策略和共享 Editor/Player 仍未建立 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E10](135-n31-e10-formal-vm-parity-audit.md)、[E11](137-n31-e11-runtime-session-save-audit.md)、[E12](138-n31-e12-monotonic-meta-audit.md)、[E13](139-n31-e13-bounded-10k-step-audit.md)、三宿主 Golden、玩家 E2E |
