...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N31-E5/E6 已形成正式 canonical History、Back/Forward、分支截断、tombstone、Barrier 阻断和 Normal/Auto/Skip Read/Skip All/Instant 调度内核；E9 发现 History 尚未随 Save 持久化，且 Meta Progress 会随完整 checkpoint Back 回退；Player 控件、真实媒体策略、宿主协调和三端证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E6](131-n31-e6-runtime-scheduler-audit.md)、[N31-E9](134-n31-e9-runtime-engineering-exit-audit.md)、Editor/Player/三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | N31-E1–E8 已建立正式 State、PRNG、Effect/Barrier、State Save、History、Scheduler、10k-seed Corpus 和 Source Map 诊断；E9 出口审计未通过：VM-11 Session Save、VM-13 monotonic Meta、VM-14 10k-step 与 VM-15 Story Outcome Hash 阻断出口，VM-02/03/07/08/12 正式向量不完整。玩家槽、真实媒体策略和共享 Editor/Player 也仍未建立 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E8](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[E9 出口审计](134-n31-e9-runtime-engineering-exit-audit.md)、三宿主 State/Save/History/Diagnostic Golden、玩家 E2E |
...
| AC-07 | 三端结局/Save/Back 一致 | N31/N80–N82/N92 | 实现中 | E9 确认 State Save 与 History 仍是分离协议，Load 后不能恢复同一 Cursor/Back/Forward 链；Meta Progress 还会随剧情 checkpoint 回退。E11/E12、三端 Player、设备与存档槽均未完成 | [N31-E4](129-n31-e4-runtime-save-load-audit.md)、[N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E9](134-n31-e9-runtime-engineering-exit-audit.md)、三端 Session Save Hash 0 差异 |
...
| AC-16 | 每句 Back/Forward 和分支截断 | N31/N52 | 实现中 | N31-E5 的剧情 checkpoint、Forward-required、原子截断、tombstone 与 Barrier Golden 有效；E9 发现完整 State 恢复同时回退 Meta Progress，且 reversible reconciliation 计划未闭环。E12、玩家控制、媒体宿主协调、三端与真人证据仍缺 | [N31-E5](130-n31-e5-runtime-history-audit.md)、[N31-E9](134-n31-e9-runtime-engineering-exit-audit.md)、玩家 History E2E |
