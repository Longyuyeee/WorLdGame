...
> 集成边界：当前开发链仍未进入 `main`；N31 集中基线为 Authoritative。N32-E1–E3 已在 Draft PR #52–#54 通过未集成 Engineering；N32-E4 已在 Draft PR #55 run `32464584207` / job `96718382563` 用时 4 分 15 秒并通过完整门。N32-E5 本地实现与完整门已通过，远端 Draft PR/CI 待创建，因此仅记录为 Engineering 候选。`RA-N21-004` 持续阻断 N32 Product Acceptance、N40 及以后、M1 Stable 与发布。
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | E14 复审 VM-01–VM-15 为 15/15 完整；N32-E1–E4 已完成正式执行、观察、Fresh Run 与调试控制；E5 候选已接入 Editor Effect Host 的 awaited/cancel/Barrier/reconciliation。仍缺共享 Player Host、热更新、玩家槽和三端真实媒体策略 | [E1](126-n31-e1-runtime-kernel-audit.md)–[E14](140-n31-e14-runtime-engineering-exit-reaudit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E5](147-n32-e5-preview-effect-host-audit.md)、三宿主 Golden、玩家 E2E |
...
| REQ-QA | 任意入口运行、断点/单步、状态检查、结构错误、循环、源码跳转 | N30/N60 | N31/N32/N40 | 实现中 | Compiler/Runtime 已有 CFG/SCC、Source Map 与结构化诊断；N32-E3/E4 已支持 Fresh Run 与调试控制，E5 候选可观察并处理 Effect/Barrier/History Host 边界。仍缺断点管理、Watch、Solver 和完整 Debugger E2E | [N30-E2 审计](124-n30-e2-compiler-completion-audit.md)、[N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E3](145-n32-e3-run-from-target-audit.md)–[N32-E5](147-n32-e5-preview-effect-host-audit.md)、QA Golden、Debugger E2E |
...
| AC-05 | 任意语句预览和变量 | N32/N60 | 实现中 | E1–E4 已完成正式执行、状态观察、Fresh Run、Run to Cursor、Step Over 与 History；E5 候选补上 Editor Effect/Barrier Host。仍缺断点/Watch、热更新、共享 Player Host、完整 Debugger E2E 和产品验收，因此不得记为通过 | [N31-E8 审计](133-n31-e8-runtime-source-map-diagnostics-audit.md)、[N32-E1](142-n32-e1-formal-editor-preview-audit.md)–[N32-E5](147-n32-e5-preview-effect-host-audit.md)、Debugger E2E |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | Runtime E3 已形成 Direction → Effect Intent；N32-E5 候选在 Editor 执行 await/cancel、Barrier 和 History Host 协调。复杂镜头、共享 Player Host 与三端媒体宿主仍缺 | [N31-E3 审计](128-n31-e3-runtime-effect-barrier-audit.md)、[N32-E5](147-n32-e5-preview-effect-host-audit.md)、Media Golden 三端快照 |
