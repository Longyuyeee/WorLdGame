...
| USP-09 | Skip / History / Back | N31/N52 | 实现中 | N52-E1 已接入 History/Back/Forward；E2 接入最小手动 Save/Load；E3a 本地候选升级为 v2 元数据、strict v1 兼容、12 槽分页、Host 截图合同与 Blob 原子存储。Auto/Quick/Skip、检查点/恢复、三端与真人证据仍缺 | [N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、[N52-E2](239-n52-e2-player-save-slots-audit.md)、[N52-E1](238-n52-e1-history-backed-player-core-audit.md)、三端状态一致 |
...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N52-E1/E2 已贯通 History 与最小 Save/Load；E3a 增加 strict v1 copy-on-write、12 槽分页、Host 捕获及同事务 Blob；N52-E3b Auto / Quick 候选增加 auto 5 环、quick 1、串行写与失败保留。检查点/恢复/Museum、播放 Auto/Skip、真实设备和 Windows/Android 宿主仍缺 | [N52-E3b](242-n52-e3b-auto-quick-save-audit.md)、[N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、[N52-E2](239-n52-e2-player-save-slots-audit.md)、三宿主 Golden |
...
| AC-07 | 三端结局/Save/Back 一致 | N31/N80–N82/N92 | 实现中 | E2 已证明 Web Session Save/Load-only rehydrate；N52-E3a v2 元数据与截图候选增加 strict v1 兼容、12 手动槽、Host compositor 合同及 Blob/元数据原子事务。Web 默认没有正式 compositor，三端 Host/设备、Auto/Quick、checkpoint/recovery 与旧版本 Museum 仍未完成 | [N52-E3a](241-n52-e3a-save-metadata-preview-audit.md)、[N52-E2](239-n52-e2-player-save-slots-audit.md)、[N31-E11](137-n31-e11-runtime-session-save-audit.md)、三端 Session Save/Outcome Hash 0 差异 |
