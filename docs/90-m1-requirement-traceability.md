...
| REQ-RUNTIME | 确定执行、剧情/媒体、Save/History/Auto/Skip/Back、输入、源码错误 | N31/N32/N50/N52 | N20/N30 | 实现中 | VM-01–VM-15 为 15/15；N50-E4 将 Pointer/Keyboard/Gamepad/System/Lifecycle 收敛到同一 portable Core intent，加入 Choice 焦点、fresh restart 与 project identity reset；E3 channel/recovery 保持。持久存档/历史/控制 UI、真实设备和三端宿主仍缺 | [N50-E4](216-n50-e4-player-input-lifecycle-audit.md)、[N50-E3](215-n50-e3-player-media-parity-recovery-audit.md)、三宿主 Golden、玩家 E2E |
