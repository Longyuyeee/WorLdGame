...
| REQ-SEQ | P0 语句块、排序/复制/批量/折叠、Inspector、跨视图定位 | N21/N41 | N21 | 实现中 | 完整工程已有全部 P0 卡片、类型化 Inspector、搜索、复制/移动/批量/折叠；N41-E1 已统一正式 Sequence，E2 已关闭 1,000 次全 P0 Sequence/Script 同源互改门，E3 又完成 Route-first lazy 对白插入/移动/删除、角色引用、原子保存与完整重建。仍缺控制流 lazy 结构族、N21 真人、N41 完整出口与 Product Acceptance | [N41-E1](181-n41-e1-formal-sequence-mode-audit.md)、[N41-E2](183-n41-e2-sequence-script-scale-audit.md)、[N41-E3](184-n41-e3-lazy-dialogue-structure-audit.md)、[N40-E8g](170-n40-e8g-lazy-sequence-projection-audit.md)–[N40-E8j](173-n40-e8j-lazy-narration-structure-flow-audit.md)、[N21 真人执行包](114-n21-human-validation-execution-kit.md) |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | N41-E1 已证明标签结构同源；E2 已完成 1,000 次全 P0 Sequence/Script 互改；E3 已证明 lazy 对白经角色索引、Script、IndexedDB 原子保存、Compiler/Route、完整重建和重开保持 stable ID。Stage、控制流 lazy 结构命令与 N41–N43 完整跨视图协议仍缺 | [N41-E1](181-n41-e1-formal-sequence-mode-audit.md)、[N41-E2](183-n41-e2-sequence-script-scale-audit.md)、[N41-E3](184-n41-e3-lazy-dialogue-structure-audit.md)、ChangeSet/Hash 对照 |
