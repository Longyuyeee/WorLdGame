...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1 候选已完成 16:9 画布定位、stable-ID patch、保存重开与 Runtime Host 有界数值 payload；production browser 实际为 75/45、r2/s2、console 0 error。Draft PR #66 Windows 完整门绿色，10k VM 67.983 秒；真实媒体文件桥接仍未关闭，故 E1 为 4/5 候选。多轨、关键帧、镜头、模板仍缺 | [N42-E1 审计](187-n42-e1-stage-director-placement-audit.md)、[N22 退出审计](113-n22-exit-condition-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1 已证明 Stage 点击生成同一 stable-ID Script patch，并在保存重开与正式 Runtime Host 保持 75/45；真实媒体 production-browser 子门、完整时间线和 N43 七模式仍未关闭 | [N42-E1 审计](187-n42-e1-stage-director-placement-audit.md)、[N41 出口复审](185-n41-engineering-exit-reaudit.md)、ChangeSet/Hash 对照 |
