...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E8 已关闭真实媒体 Stage、关键帧/时间尺、折线路径、基础 Camera、作用域转场与文本模板；E9 新增单命令三次贝塞尔路径，图形控制点、Inspector、Story Language、Compiler、Runtime/Host、Canvas/DOM Preview 与保存重开共享同一 Move；Draft PR #72 Windows 完整门全绿，10,000 条规划为 `13.97ms <500ms`。高级镜头、独立时间写入和正式 Player 一致性仍缺 | [N42-E9](199-n42-e9-bezier-character-path-audit.md)、[N42-E8](198-n42-e8-dialogue-presentation-templates-audit.md)、AC-13 |
