...
|---|---|---|---|---|---|
| USP-01 | One Story, Many Views | N40–N43 | 实现中 | N41 Engineering 出口已通过；N42 Stage 继续使用同一 stable-ID Script；N43-E1b 冻结统一上下文，E5 让 Production 投影同一 Asset Index/Lifecycle，E6 又让 Debug & QA 对当前 stable ID 消费正式 Compiler/Runtime/Source Map 并返回 Sequence 修复。Mobile Focus 与完整时间写入仍缺 | [N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、任意工程七模式+Preview+Debugger 同源 E2E |
...
| USP-06 | Professional Studio | N41–N43/N100 | 实现中 | N43-E1–E4 建立统一上下文、Beginner/Pro、Motion 与输入/同步；E5 开放 Production，E6 开放正式 Debug & QA 检查与源码修复闭环，当前 6/7。Mobile Focus 及 Utage 级本地化/配音批量列仍缺 | [N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、七模式真实任务、商业演出、Benchmark Episode |
...
| REQ-UX | 设计 Token、七模式、Beginner/Pro、统一语义、连续动效、60 FPS、减少动效、多模态状态 | N43/N101 | N21/N40–42 | 实现中 | E5 增加 Production 桌面表/手机状态卡；E6 增加 Debug & QA 正式检查、严重级别筛选和源码定位，真实视觉差异修正后 390px 主按钮 `351×48px`、定位 `317×44px`、横溢出 0，当前 6/7。Mobile Focus、真实 OS/目标设备与真人证据仍未完成 | [N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、[N43-E4](207-n43-e4-input-sync-and-exit-audit.md) |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | N42 Stage 由 stable-ID Script 驱动；N43-E1b 保存统一上下文，E5 Production 恢复同一资源，E6 Debug & QA 对同一 `stmt_gate_bg` 运行正式链并返回 Sequence，保存重开仍恢复。完整时间写入和 Mobile Focus 未关闭 | [N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、ChangeSet/Runtime 对照 |
...
| AC-11 | 七模式修改同一语句 | N43 | 实现中 | E5 开放 Production 资源写入；E6 开放 Debug & QA，对同一 stable ID 执行正式链、定位回 Sequence 并保存重开，当前 6/7。Production 写资源而非语句，Mobile Focus 仍禁用，因此完整字面门未通过 | [N43-E6](209-n43-e6-debug-qa-workspace-audit.md)、七模式 E2E |
