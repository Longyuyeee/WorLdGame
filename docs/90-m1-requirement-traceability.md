...
| USP-06 | Professional Studio | N41–N43/N100 | 实现中 | N43-E1 建立四个可用工作模式与统一上下文；E2 增加 Beginner/Pro 可逆披露，真实 Chrome 证明 Beginner 编辑与 Pro 恢复不丢 stable-ID 或专业工具 | [N43-E2](205-n43-e2-progressive-disclosure-audit.md)、七模式真实任务、商业演出、Benchmark Episode |
...
| REQ-UX | 设计 Token、七模式、Beginner/Pro、统一语义、连续动效、60 FPS、减少动效、多模态状态 | N43/N101 | N21/N40–42 | 实现中 | N43-E1 已关闭四个可用模式和统一上下文；E2 关闭 Beginner/Pro 可逆披露，Beginner 只隐藏复杂度，Pro 无损恢复，真实 Chrome 桌面/390px console 0、Preview `352×198`、横溢出 0。其余三模式、全局减少动效/帧时间和真人证据仍未完成，N21 `0/1`、N23 `0/2` | [N43-E2](205-n43-e2-progressive-disclosure-audit.md)、[N43-E1b](204-n43-e1b-workspace-context-audit.md)、[N21 执行包](114-n21-human-validation-execution-kit.md)、D1 任务报告 |
...
| AC-12 | 动效不阻塞且有减少动效 | N43 | 实现中 | E2 新增复杂度开关使用 motion token 并为该开关补 `prefers-reduced-motion`；全局可中断过渡、帧时间和减少动效矩阵仍未覆盖 | [N43-E2](205-n43-e2-progressive-disclosure-audit.md)、E3 帧时间/可中断/减少动效测试 |
