...
| REQ-STAGE | 画布、安全区、变换、模板、多轨、关键帧、缓动、三视图同步 | N22/N42 | N20/N31 | 实现中 | E1–E7 已关闭真实媒体 Stage、Move easing、基本关键帧、派生时间尺、两段 stable-ID Move 路径、基础 Camera 与作用域转场；E8 已冻结 ADV/NVL/Bubble 文本模板，贯通 canonical、Compiler、Runtime/Host、TEXT lane、Preview 与重开，NVL 实际累积且有 8 行上限；Draft PR #71 Windows 完整门全绿。任意/贝塞尔路径、镜头高级效果、独立时间写入和正式 Player 一致性仍缺 | [N42-E8](198-n42-e8-dialogue-presentation-templates-audit.md)、[N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、AC-13 |
...
| AC-03 | Route/Sequence/Script/Stage 同源 | N40–N43 | 实现中 | E1b–E7 已证明 Stage、关键帧、时间尺、路径、Camera 与转场均由 stable-ID Script 驱动；E8 的 ADV/NVL/Bubble 也只保存 canonical textbox 指令，Compiler、Runtime/Host、TEXT lane、Preview 与重开均重建同一事实，没有第二套文本或时间线状态。完整时间写入和 N43 七模式仍未关闭 | [N42-E8](198-n42-e8-dialogue-presentation-templates-audit.md)、[N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、ChangeSet/Runtime 对照 |
...
| AC-13 | 镜头/角色/转场/BGM/Voice/SFX | N42/N50 | 实现中 | E2–E6 已让真实角色 Move、关键帧、派生时间尺、两段路径和基础 Camera 进入正式链；E7 关闭三类基础背景转场及 clear 离场的 Canonical→资源窗口→Runtime/Host→分层 Canvas Preview→重开闭环。任意/贝塞尔路径、镜头高级效果、自定义 shader、真实 Player 渲染/音频 Adapter 与三端媒体宿主仍缺 | [N42-E7](197-n42-e7-scoped-stage-transitions-audit.md)、[N42-E6](196-n42-e6-basic-camera-audit.md)、[N32-E7](150-n32-e7-shared-runtime-host-audit.md)、Media Golden 三端快照 |
