...
> 决策日期：2026-08-12
> 状态：证据契约已冻结；[Spike 01](68-cl04-vm-kernel-spike-01.md)–[12](79-cl04-vm-generated-web-worker-conformance-spike-12.md) 已完成 VM-01–15 Node 基础、10k 固定语料及 Node/Web Worker 基础、History/Scheduler/Save 与 10k Corpus 对照；CL-04 进行中但未通过
> 风险：CL-04
...
现有编辑代码提供编辑事务、Preview 播放按钮、资源调度和项目恢复候选证据；独立 `narrative-vm-spike` 的 [Spike 01](68-cl04-vm-kernel-spike-01.md)–[12](79-cl04-vm-generated-web-worker-conformance-spike-12.md) 已提供 VM-01–15 Node 基础、10k 固定语料，以及 Node/Web Worker 的基础、History/Scheduler/Save Trace 与 10k Corpus 摘要对照。当前跨宿主 Corpus 尚未覆盖完整 Effect/Barrier/Meta/Skip 逐记录矩阵、持久存储、Windows/Android 壳或真机；独立审阅也未完成，因此 CL-04 只能标记“进行中”，不得视为正式 VM 或通过。
