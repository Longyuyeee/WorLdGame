...
| 集成 | 当前头相对 `origin/main` 为 `0 behind / 336 ahead`；main-target Authority PR #61 仍 open Draft | 无代码分叉，但堆叠审阅风险上升 |
...
4. **堆叠集成风险（中高风险）**：当前开发头已比 main 多 336 个提交，Authority PR #61 仍是 Draft。继续叠加会提高冲突、回归定位和维护者审阅成本。
...
| main 集成 | Authority 已审阅合入 | PR #61 仍 open Draft；当前头比 main 多 336 个提交 | **未完成** |
