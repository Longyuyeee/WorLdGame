...
N43-E4 已冻结键盘/触屏任务等价、跨视图真实同步预算并完成出口矩阵，见 [#207](207-n43-e4-input-sync-and-exit-audit.md)。E4 共同交互子门通过，但总出口因 Production、Debug & QA、Mobile Focus 仍 disabled 而失败（4/7）；后续必须在 N43 授权内按真实任务关闭三模式，不能直接越权进入 N50。
