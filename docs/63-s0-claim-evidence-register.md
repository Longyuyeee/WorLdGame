...
| CL-04 | Narrative VM 可确定回滚、前进、快进与 Barrier | 未开始 | Runtime Owner | Architecture + QA | 三端 State Hash 0 差异；不可重放副作用必须显式 Barrier | Preview transport 不计 | 冻结最小 Step/Effect/Save 契约 |
