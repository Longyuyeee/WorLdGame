...
| 10k Route 图 | 已有真实 10k 二叉分支图、64 节点窗口、搜索/过滤、布局交互、最终复跑单场景编辑 P95 `62.14 ms`；Formal Runtime 当前/访问/choice edge 高亮支持 Back/Forward 与窗口回锚；仍是完整 Canonical 源读取 | 冷启动正文局部读取、production browser 与内存/缩放产品验收 |
