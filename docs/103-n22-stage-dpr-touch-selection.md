...
- 错误解码/切场景矩阵已由[第三切片审计](104-n22-preview-media-host-safety.md)补齐，Renderer 边界已由[第四切片审计](105-n22-render-host-boundary.md)冻结；DOM Stage 仍是 Editor Preview，Canvas/Pixi 高性能后端尚未实现；
- 尚未生成可审查的视觉 Golden；
